...
(def stage-component {:container-name :stage-component
...
(def add-stage-buttons {:container-name         :add-stage-buttons
                        :ctx                    [:application-id :tournament-id]
                        ...
                        [:add-button :on-click] (fn [h _]
                                                  (rc/dispatch h :create-stage :group))
                        ...
                        [:add-knockout :on-click] (fn [h _]
                                                    (rc/put! h assoc :gensym (gensym))
                                                    #_(rc/dispatch h :create-stage :knockout))



                        :create-stage           (fn [{:keys [ctx] :as h} stage-type]
